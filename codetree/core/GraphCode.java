...
public interface GraphCode {
    ...
    // abstract SearchInfo enumerateFollowableFragments(Graph g, SearchInfo info,
    // IndexNode m, int v);
    abstract Pair<CodeFragment, SearchInfo> enumerateFollowableFragments(Graph g, SearchInfo info,
            int v, HashSet<Byte> childrenVlabel);

    abstract List<ArrayList<CodeFragment>> computeCanonicalCode(int labels_length);

    abstract SearchInfo undo(Graph g, SearchInfo info);
